...
### خطوة مهمة بعد التحديث (حل 404)
- من لوحة التحكم: **الإعدادات > الروابط الدائمة** ثم اضغط **حفظ التغييرات** مرة واحدة لإعادة توليد قواعد الروابط.
- تأكد أن إضافة `growthytools-catalog` مفعّلة قبل اختبار صفحات القوالب الفردية.
