...
$docs_url       = (string) growthytools_get_meta($post_id, '_gt_documentation_url', '');
...
<section class="gt-single-hero gt-section">
    ...
    <div class="gt-actions">
        ...
        <?php endif; ?>
        <?php if ($docs_url) : ?>
            <a class="gt-button gt-button--ghost" href="<?php echo esc_url($docs_url); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e('دليل الاستخدام', 'growthytools'); ?></a>
        <?php endif; ?>
        <?php if ($support_url) : ?>
